  ...
  switch (status) {
    ...
    case 'final_accept':
      return {
        ...
        text: `Hello ${data.applicantName},\n\nCongratulations! Thank you for completing the application process. We enjoyed getting to know you, and would love to onboard you onto Waterloop as a ${data.position}.\n\nOur New Members Orientation will be held virtually on ${data.newMembersDate} from ${data.newMembersTime}. You can join with this link: ${data.newMembersMeetingLink}.\n\nPlease confirm that you are interested in taking the position by filling out ${data.newMembersFormLink} by ${data.newMembersFormDeadline}. Upon completion, we will be providing you with more onboarding details and getting you set up with your very own @waterloop email! We look forward to working with you soon!\n\n${data.execName}\n${data.subteam} Team Lead\n`,
      };
